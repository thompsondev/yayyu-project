...
import emptyWishList from "../../assets/wishlist 1.png"
  ...
  return (
    <div className='bg-[#F5F5F5]'>
        ...
        <div className='max-w-full-md mx-auto md:px-24 max-w-full-sm sm:px-6 max-w-full-lg lg:px-32 '>
            <div className='mt-14 '>
                <div className='flex items-top justify-center gap-x-4 mb-14'>
                    <div className='bg-white h-[420px] w-1/4 shadow-sm'>
...
{/* 
            ...
            {item.charAt(0).toUpperCase() + item.slice(1)}   
                    ...
                    <div className='bg-white h-[420px]  w-3/4 shadow-sm p-10 flex items-center justify-center'>
                    {renderContent()}
